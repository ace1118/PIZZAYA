...
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(26815644);
}
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(12514540);
}
if (isConditionTrue_0) {
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(26842852);
}
if (isConditionTrue_0) {
{gdjs.deviceVibration.startVibration(50);
}}
